...
\author{The WelfareWeights Project\\ \href{https://welfareweights.com}{welfareweights.com} \quad\textbullet\quad \href{\repo}{github.com/welfareweights/engine}}
\date{July 2026}
...
The formal rulebooks for this arithmetic are the reference-case guidelines for benefit-cost analysis in global health and development \cite{robinson2019} (which cite Salomon et al.\ 2012 by name as the source of the weights they monetize) and, for US rulemaking, the HHS Guidelines for Regulatory Impact Analysis \cite{hhs2016}. Both take health-state weights as inputs to the benefit calculation; producing those inputs transparently is exactly the step this engine makes auditable.
...
The weights come from surveys, and the surveys deliberately do NOT ask ``rate this condition from 0 to 1'' (people are bad at that). They ask two kinds of easier questions, and the estimation problem is to reassemble the 0-to-1 scale from the answers. The engine implements the reassembly used for the GBD weights \cite{salomon2012,salomon2015}, in three stages.
...
\end{equation}
This is Thurstone's comparative-judgment model \cite{thurstone1927}. Intuition: states far apart in $\theta$ produce near-unanimous answers; states close together produce closer to 50/50. The observed disagreement \emph{rates} are exactly what identifies the spacings.
...
\href{https://content.sph.harvard.edu/wwwhsph/sites/2447/2019/05/BCA-Guidelines-May-2019.pdf}{content.sph.harvard.edu/.../BCA-Guidelines-May-2019.pdf}.
