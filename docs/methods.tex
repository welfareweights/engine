...
The formal rulebooks for this arithmetic are the reference-case guidelines for benefit-cost analysis in global health and development \cite{robinson2019} and, for US rulemaking, the HHS Guidelines for Regulatory Impact Analysis \cite{hhs2016}. Both take health-state weights as inputs to the benefit calculation; producing those inputs transparently is exactly the step this engine makes auditable.
